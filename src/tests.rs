...
mod tests {
    ...
    fn test_set_drbg_seed() {
        ...
        let rand_bytes1 = (kem.params.random_bytes)(16, None);
        assert_eq!(rand_bytes1.len(), 16);
        ...
        let rand_bytes2 = (kem.params.random_bytes)(16, kem.drbg.as_mut());
        assert_eq!(rand_bytes2.len(), 16);

        // Ensure DRBG output is deterministic
        let rand_bytes2_init: [u8; 16] = [21, 115, 212, 133, 136, 19, 186, 226, 132, 198, 0, 183, 126, 71, 212, 214];
        assert_eq!(rand_bytes2, rand_bytes2_init);
    }
}